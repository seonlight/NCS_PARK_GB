...
$thumb_height = ($options['thumb_height'])?$options['thumb_height']:650;
...
<div class="main_slider">
	...
	$txt_big = ($list[$i]['wr_1'])?$list[$i]['wr_1']:"HERZ'S HAIR";
	$txt_small = ($list[$i]['wr_3'])? $list[$i]['wr_3']:'건강한 아름다움으로 <br>그녀의 마음까지 스타일링하다.';
	...
	<div class="slide" style="background:#1f202a url(<?php echo $img;?>) no-repeat 50% 0;">
		<div class="wrap">
         ...
         <a href="<?php echo $list[$i]['href'] ?>" class="ico_more">view more</a>
		 </div>
		</div>
	</div>
    <?php }  ?>
